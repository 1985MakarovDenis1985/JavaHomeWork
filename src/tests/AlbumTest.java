...
class AlbumTest {
    ...
    void setUp() {
        albums = new Album(5);
        photos = new Photo[4];
        photos[0] = new Photo(1, 1000, "birthday", "Asia", LocalDateTime.of(2018, 8, 11, 13, 3, 15));
        photos[1] = new Photo(2, 2000, "wedding", "Europe", LocalDateTime.of(2019, 7, 7, 21, 11, 30));
        photos[2] = new Photo(3, 3000, "walking", "Asia", LocalDateTime.of(2021, 3, 21, 19, 47, 45));
        photos[3] = new Photo(2, 2200, "walking", "Europe", LocalDateTime.of(2022, 3, 21, 19, 47, 45));
    ...
    void testAddPhoto() {
        ...
        Photo p1 = new Photo(5, 5000, "Jasmin", "songs", LocalDateTime.of(2025, 3, 21, 19, 47, 45));
        assertTrue(albums.addPhoto(p1));
        Assertions.assertEquals(p1, albums.getPhotoFromAlbum(5, 5000));
        Photo p2 = new Photo(6, 6000, "Jasmin", "songs", LocalDateTime.of(2025, 3, 21, 19, 47, 45));
    ...
    void testUpdatePhoto() {
        Photo p = new Photo(2, 2000, "wedding", "Ukraine", LocalDateTime.of(2019, 7, 7, 21, 11, 30));
        albums.updatePhoto(2, 2000, "Ukraine");
        assertEquals(p, albums.getPhotoFromAlbum(2, 2000));
        assertFalse(albums.updatePhoto(6, 6000, "USA"));
    }
