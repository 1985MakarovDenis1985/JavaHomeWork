...
public class RentCompany extends AbstractRentCompany implements Serializable {
    ...
    TreeMap<LocalDate, List<RentRecord>> returnedRecords = new TreeMap<>();
    HashMap<String, Model> models = new HashMap<>();

    static final long serialVersionUID = -4706132283506089067L;
    ...
    * */
    public static RentCompany restoreFromFile(String fileName) {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(fileName))) {
            rentCompany = (RentCompany) ois.readObject();
